...
Can’t easily produce an accurate master lease list?
            ...
            <Card.Text className="cardTxt">
              As your portfolio begins to grow, it can become difficult to
              maintain an accurate and detailed list of each and every location.
            </Card.Text>
          </Card.Body>
        </Card>
      </div>
...
Spreadsheets becoming a hassle to maintain?
            ...
            <Card.Text className="cardTxt">
              Spreadsheets are great for viewing data, not managing data. It’s
              easy to make mistakes and hard to keep things organized.
            </Card.Text>
          </Card.Body>
        </Card>
      </div>
